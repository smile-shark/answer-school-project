...
class Headers:
    ...
    @staticmethod
    def STUDENT_INFO_HEADERS(token):
        Headers.globalInfo['Authorization'] = token['token_type'] + ' ' + token['access_token']
        Headers.globalInfo['Referer'] = 'https://ai.cqzuxia.com/'
        return Headers.globalInfo

    @staticmethod
    def TEACHER_INFO_HEADERS(token):
        Headers.globalInfo['Authorization'] = token['token_type'] + ' ' + token['access_token']
        Headers.globalInfo['Referer'] = 'https://zxsz.cqzuxia.com/'
        return Headers.globalInfo
